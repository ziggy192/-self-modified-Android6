...
//    }
    ...
    private void createBullet() {
        Utils.playSoundInNewThread("resources/Laser_Shoot.wav",false);
...
//    );
    ...
    public static PlaneController newPlaneController1(){
    ...
    public static PlaneController newPlaneController2(){
        return new PlaneController(
                new Plane(GameConfig.instance.getScreenWidth()  / 2, GameConfig.instance.getScreenHeight() - Plane.PLANE_HEIGHT),
